...
sum up software earnings in one quote it would be the following from Yamini Rangan, the Hubspot CEO:
...
we’re also starting to see some consumer weakness in the guides of companies like Shopify, Etsy, Doordash, Uber, eBay, etc.
...
### Update on Multiples
Multiples shown below are calculated by taking the Enterprise Value (market cap + debt - cash) / NTM revenue.
- Overall Median: 5.7x
- Top 5 Median: 15.5x
- 10Y: 4.5%

high growth >27% projected NTM growth (I had to update this, as there’s only 1 company projected to grow >30% after this quarter’s earnings), mid growth 15%-27% and low growth <15%
