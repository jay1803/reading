...
The simple version comes from [Working Harder and Smarter](https://www.notboring.co/p/working-harder-and-smarter), which I wrote last September:
...
At the end of all of the interviews we do for [Age of Miracles](https://open.spotify.com/show/6k1YLBvORRMyosKy3x1xIl?si=5f01ccb1b16945ae), we ask each guest what the world will look like when we have abundant energy. Isaiah Taylor, the founder of Valar Atomics, gave an answer that frames the situation perfectly:
...
This will certainly mean change for workers – I’m in the camp that believes [we’ll do more fulfilling work and non-work with our time](https://www.notboring.co/p/the-appetizirp) – and it will certainly mean surplus for consumers. If the cost of everything decreases, everyone can have more of what they need.
...
Marc Andreessen wrote [Why Software is Eating the World](https://a16z.com/why-software-is-eating-the-world/). He wrote about Amazon eating books and Netflix eating entertainment and Google eating direct marketing. He wrote about software enabling the truly big markets, like oil & gas, defense, and retail.

这件作品是有先见之明的。当他在2011年第三季度写下这篇文章时，苹果是市值最大的公司，Microsoft是第五大公司，但前10名主要由石油公司主导，市值要小得多。

In the incredible [Acquired conversation with NVIDIA CEO Jensen Huang](https://www.acquired.fm/episodes/jensen-huang), David Rosenthal tells a story from the early days of Sequoia to highlight that venture returns can always get bigger as technology’s market grows:
...
What happens when energy, intelligence, and dexterity get cheaper?
Jensen gives his answer, focusing only on intelligence:
...
Tech companies are going to get much bigger for two separate reasons, which will converge:
...
[Anduril](https://www.notboring.co/p/anduril-acquiring-prime) is a spiritual descendent of SpaceX with a key evolution: it’s betting that by launching hardware products on top of its AI-powered software operating system, Lattice, it will be able to “deliver more capable hardware products for less money, and that its advantages will compound with each new product it plugs in.”
...
Of course, there are aerospace and defense startups, companies I’ve written about like [Varda](https://www.notboring.co/p/varda-the-space-drug-factory) and Array Labs, plus dozens more credible and well-backed teams, many of which hail from SpaceX and Anduril themselves.
...
In [Intelligence Superabundance](https://www.notboring.co/p/intelligence-superabundance), I argued that AI wouldn’t replace the need for human workers, but that thanks to concepts like [induced demand](https://caseyhandmer.wordpress.com/2022/05/21/traffic-congestion-and-city-design/) and [Jevons Paradox](https://en.wikipedia.org/wiki/Jevons_paradox#:~:text=In%20economics%2C%20the%20Jevons%20paradox,enough%20that%20resource%20use%20is), more intelligence would create demand for even more intelligence.
