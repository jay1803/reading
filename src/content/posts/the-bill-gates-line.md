...
The Bill Gates Line is definition of Platform by Bill Gates.
> A platform is when the economic value of everybody that uses it, exceeds the value of the company that creates it. Then it’s a platform.

By this measure Windows was indeed the ultimate platform

### Aggregators, Not Platforms
In the aggregator business model the aggregator owns customers and suppliers follow.
It follows that Facebook and Google’s “platforms” not only don’t meet the Bill Gates Line, they don’t even register on the graph: they are the purest expression of aggregators.
