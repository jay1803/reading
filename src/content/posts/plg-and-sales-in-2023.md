...
PLG and sales from some of the top SaaS startups including Figma, ClickUp, Webflow, Zapier, Supermetrics, and Hotjar.
Your five step plan:
...
3. Call on every new free user independent of what they’ve done in the product.
4. Over-index on commercial conversations rather than customer experience and delivering value upfront.
5. Get too greedy on the initial purchase.
6. Only talk to existing product users rather than navigating to the buyer.
...
2. The complexity of their existing systems
3. The level of product sophistication
...
In my experience, users who opt-into a sales touchpoint tend to convert at far higher rates than ones who don’t.
sales is an expensive resource...recommend validating that sales is both incremental and efficient before fully scaling up the team.
