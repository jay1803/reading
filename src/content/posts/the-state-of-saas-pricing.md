...
我注意到越来越多的 SaaS 企业开始转向 Usage-Based Pricing Model
这些定价模型有很多优点：
...
SaaS 公司长期以来依赖的定价模式对于客户的采用模式或价值实现不再有意义。
自动化、人工智能和 API 优先产品等软件趋势与传统的基于席位的订阅并不相符：
- Automation
- AI
- API-first

What I realized, though, was that [usage-based pricing wasn’t merely a pricing change](https://www.growthunhinged.com/p/usage-based-pricing-20).
### What’s happening in the market
至少自 2018 年以来，基于使用的定价 (UBP) 一直在上升。SaaS 公司的采用率似乎正以翻倍的速度从 2018 年的 27% 增加到 2022 年接近一半。

This [data](https://openviewpartners.com/2023-saas-benchmarks-report/) comes from over 3,000 respondents aggregated across six years of surveying private SaaS businesses, including more than 700 from 2023.

A majority of usage-based businesses have a hybrid model rather than pure usage-based or pay-as-you-go (PAYG) pricing.
...
您正在销售一项复杂的多产品交易，其中每种产品都由组织中的不同人员使用。在这种情况下，一些 SaaS 公司采用“保留”式模型，客户承诺一定的支出水平，然后根据分配给不同产品的实际许可证灵活地减少支出。
### Common pitfalls of usage-based pricing
基于使用情况的定价或混合定价并不适用于所有产品
#### Taximeter effect
- 当美国在线 (AOL) 将拨号互联网定价从按小时付费改为无限量供应时，互联网使用量增加了两倍。基于使用的定价实际上导致了互联网使用的减少。 （这是 20 世纪 90 年代末的事了😬）
...
#### Fear about a lack of predictability.

#### Internal behaviors don’t match the new model.
A traditional SaaS go-to-market org looks something like an assembly line. Marketing generates the opportunity, SDRs qualify it, AEs close the deal, etc.

This operating model doesn’t apply particularly well in a usage-based context.
making sure your customers are seeing value. That includes things like:
