...
Allow users to quickly search over S3 files (JSON, CSV, Parquet, Avro) using MongoDB query language (MQL).
...
I'm not sure how much this will cut much into Elastic's bread and butter, it more prevents current users from having to look elsewhere for that feature.
### MongoDB Charts (GA)
