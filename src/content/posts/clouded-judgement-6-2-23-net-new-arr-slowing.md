...
Net ARR Added vs Trailing Average.

YoY change in net new ARR (Q1 ‘23 net new ARR vs Q1 ‘22 net new ARR) it paints a similar picture

So it’s clear the demand environment in Q1 was bad.
...
Crowstrike and Mongo gave us hope that the demand environment is starting to shift.
...
#### Update on Multiples
EV/Revenue Overall Stats:
- Overall Median: 5.8x
- Top 5 Median: 13.4x
- 10Y: 3.6%

I consider high growth >30% projected NTM growth, mid growth 15%-30% and low growth <15%
...
### Comps Output
It shows the number of months it takes for a SaaS business to payback their fully burdened CAC on a gross profit basis.

## BingChat
这篇文章是关于云软件公司的最新趋势和表现的。作者分析了一些公司在第一季度的核心指标，如净新ARR（年复合收入）和全年指导。作者发现，第一季度的需求环境很差，很多公司的净新ARR都低于去年同期。但是，也有一些公司，如Crowdstrike和Mongo，给出了乐观的前景，显示出需求环境正在改善。作者认为，这意味着市场开始出现分化，不同的产品和市场有不同的影响。作者还提供了一些关于估值倍数、运营指标和同行比较的数据和图表。
