...
- Important to call out - Mongo’s consumption trends will be different than Snowflake.

Azure: Neutral Tone With Strength in AI
- They were also more constructive on cloud optimizations bottoming. Some quotes: “what we're seeing now is the new workloads start in addition to highly intense optimization' and the CFO added 'at some point, workloads just can't be optimized much further.”
...
- New logo acquisition picking up
...
- Overall similar to Datadog. Another data point that optimization headwinds are not getting worse, but not necessarily getting better yet.
...
- we could start to see accelerating rev growth in August, primarily due to the lapping of tougher comps
...
- Snowflake actually saw stronger consumption in Feb / March, but then things really slowed down in April.
  对比 Edge 给出的流量数据，从 3 月份开始，访问 Snowflake 网站的流量也下降了。
- The weakness was primarily driven by larger customers (similar headwind that Datadog saw).
...
## BingChat
这篇文章的一些关键点是：
- Mongo是消费软件公司中表现最好的，它的新客户增长和消费水平都超过了预期，而且提高了全年的指引。
- AWS和Snowflake是消费软件公司中表现最差的，他们都在四月份遇到了消费增长的放缓，主要是由于大客户的优化和数据保留政策的变化。
- Azure和Datadog的消费趋势没有恶化，也没有改善，但他们对云优化触底有了一些积极的信号。
- Confluent的情况与Datadog类似，但它在Confluent Cloud上实现了连续的季度增长，这是一个亮点。
- 云软件行业的估值倍数受到了消费头风的影响，但仍然与增长率呈正相关。
- 云软件公司的运营指标显示，他们的净留存率下降了，但毛留存率仍然强劲，新客户增长有所回升。
