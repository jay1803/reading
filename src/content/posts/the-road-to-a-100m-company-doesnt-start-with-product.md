...
### Market -> Product Hypothesis Version Two
...
you need to combine qualitative measurements with quantitative measurements with your own intuition.
### 1. QUALITATIVE
To get a qualitative understanding, my preference is to use Net Promoter Score (NPS).
### 2. QUANTITATIVE
two quantitative measures to understand Market Product Fit: Retention Curves and Direct Traffic.
refer to The Never Ending Road To Product Market Fit
