...
The mistake they make is to underestimate the power of compound growth. We encourage every startup to measure their progress by [weekly growth rate](https://paulgraham.com/growth.html).
...
Airbnb is a classic example of this technique. Marketplaces are so hard to get rolling that you should expect to take heroic measures at first.
### Fragile
...
How do you find users to recruit manually? If you build something to [solve your own problems](https://paulgraham.com/startupideas.html), then you only have to find your peers, which is usually straightforward.
